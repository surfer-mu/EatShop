...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`eat`  DEFAULT CHARACTER SET utf8 ;
...
insert  into `goods`(`eatname`,`number`,`allPrice`) values ('面包',5,225),('1111',3,3333);
...
insert  into `loginaddress`(`id`,`time`,`ip`) values ('0585da78-eadc-4ab4-9c93-506b84047416','2017-7-25 13:21:43','127.0.0.1'),('0585da78-eadc-4ab4-9c93-506b84047416','2017-7-26 10:57:41','127.0.0.1'),('0585da78-eadc-4ab4-9c93-506b84047416','2017-7-26 11:17:49','127.0.0.1'),('0585da78-eadc-4ab4-9c93-506b84047416','2017-7-26 12:22:38','127.0.0.1'),('0585da78-eadc-4ab4-9c93-506b84047416','2017-7-27 14:03:14','127.0.0.1'),('0585da78-eadc-4ab4-9c93-506b84047416','2017-7-27 14:08:11','127.0.0.1');
...
insert  into `ordercart`(`orderId`,`userid`,`relname`,`tell`,`address`,`total`,`orderTime`,`username`) values ('14964100344870','1','slq','15703765673','西安',671,NULL,'slq'),('14964135114890','1','slq','12345678978','西安',414,NULL,'slq'),('14964145703900','1','slq','12345678978','西安',1412.9,NULL,'slq'),('14964621183250','6','q','12343343222','vgdsf',39.5,NULL,'qwer'),('15011356797550','0585da78-eadc-4ab4-9c93-506b84047416','非递归','112','山西',3333,'2017-07-27 14:07:59',NULL);
